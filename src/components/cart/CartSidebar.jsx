...
const CartSidebar = ({isCartOpen, toggleCart}) => {
    ...
    return (
        <div
            className={`fixed right-0 top-0 z-20 h-screen w-[400px] transform transition-transform duration-300 ease-in-out ${isCartOpen ? "translate-x-0" : "translate-x-full"}`}>
            <div
                className="flex h-screen flex-col bg-white shadow-lg dark:bg-gray-900 dark:text-gray-200 rounded-bl-3xl rounded-tl-3xl">
                {/* cart header */}
